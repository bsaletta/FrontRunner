			...
			if($project!=""){
				...
				if($result){
					...
					echo "<table border=1px>
						...
						echo "<li>".$kind.": <span id='".$kind."'onclick=\"loadResource('".$child->path."',this)\">".$child->name."</span></li>";
						}
					echo "</ul></td>
						<td id='content'></td><td>Here will go action commands and all kinds of fun stuff </td></tr>
					</table>";
				}
			}else{
				echo "False Result!";
